...
for mod in mods:
    ...
    #loading training images from its directory:
        train_image_array_gen = train_data_gen.flow_from_directory (train_image_files_path, target_size = target_size,class_mode = "binary", classes = class_list)

    #loading validation images
        valid_image_array_gen = valid_test_data_gen.flow_from_directory (valid_image_files_path, target_size = target_size,class_mode = "binary" , classes = class_list)
    ...
    #path where to save the models along the run
        ...
        ### fitting the model with 1000 epochs.
        model.fit(
        ...
        ##save the final model after the 1000 epochs (does not replace the "best" model)
